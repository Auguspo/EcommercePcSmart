...
const Footer = () => {
  return (
    <footer className="bg-danger text-white  p-4">
      <div className="container">
        <div className="row">
          <div className="col-md-4 text-md-left text-left">
            <a href="https://web.facebook.com/PCSmartbb" target="_blank" rel="noopener noreferrer" className="text-white">
              <FontAwesomeIcon icon={faFacebook} size="2x" className="mb-2" />
            </a>
            <br />
            <a href="https://www.instagram.com/pcsmart_bahia/" target="_blank" rel="noopener noreferrer" className="text-white">
              <FontAwesomeIcon icon={faInstagram} size="2x" />
            </a>
          </div>
          <div className="col-md-4 mt-md-0 mt-3 text-center">
            <div>
              &copy; {new Date().getFullYear()} PC Smart
            </div>
          </div>
