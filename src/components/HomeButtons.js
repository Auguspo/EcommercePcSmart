    ...
    <Container className="mt-5 my-5 d-flex justify-content-center">
      <Row>
        <Col xs={12} md={4} className="mb-3">
          <Button as={Link} to="/shop" variant="primary" className='bg-danger' style={buttonStyle}>
        ...
        <Col xs={12} md={4} className="mb-3">
          <Button as={Link} className='bg-danger' to="/contacto" variant="primary" style={buttonStyle}>
        ...
        <Col xs={12} md={4} className="mb-3">
          <Button as={Link} className='bg-danger' to="/login" variant="primary" style={buttonStyle}>
